...
require(['leaflet', 'tollstations', 'utils'], function(L, tollStations, utils) {
    var map = L.map('map');
...
(function() {
    ...
    function fa(a) {
        function c(b, l) {
            ...
            if (b && b.charAt(0) === ".")
                if (l) {
                    ...
                    var c;
                    for (a = 0; c = f[a]; a++)
                        if (c === ".") f.splice(a, 1), a -= 1;
                        else if (c === "..")
                        if (a === 1 && (f[2] === ".." || f[0] === "..")) break;
        ...
        function o(b) {
            ...
            if (B && J(B)) {
                ...
                if (e)(B = b.cjsModule) && B.exports !== void 0 && B.exports !== m[e] ? a = m[e] = b.cjsModule.exports : a === void 0 && b.usingExports ? a = m[e] : (m[e] = a, F[e] && (Q[e] = !0))
            } else e && (a = m[e] = B, F[e] && (Q[e] = !0)); if (C[b.id]) delete C[b.id], b.isDone = !0, g.waitCount -= 1, g.waitCount === 0 && (I = []);
            delete R[e];
        ...
        function A(b, a, f, c) {
            ...
            for (f = 0; f < a.length; f++)
                if (k = a[f]) k = h(k, d ? b : c), n = k.fullName, a[f] = n, n === "require" ? j[f] = q(b) : n === "exports" ? (j[f] = m[i] = {}, e.usingExports = !0) : n ===
                    "module" ? e.cjsModule = j[f] = {
                        id: d,
                        uri: d ? g.nameToUrl(d, null, c) : void 0,
                        exports: m[i]
                } : n in m && !(n in C) && (!(i in F) || i in F && Q[n]) ? j[f] = m[n] : (i in F && (F[n] = !0, delete m[n], S[k.url] = !1), e.depCount += 1, e.depCallbacks[f] = r(e, f), t(k, !0).add(e.depCallbacks[f]));
            e.depCount ? v(e) : o(e)
        }
            ...
            if (!b.isDone) {
                ...
                if (d)
                    for (g = 0; g < d.length; g++)
                        if (i = d[g])
                            if ((e = h(i).prefix) && (k = C[e]) && y(k, a), (e = C[i]) && !e.isDone &&
                                s[i]) i = y(e, a), b.depCallbacks[g](i);
                return c ? m[c] : void 0
            }
        }
        ...
        V = function(b) {
            if (!g.jQuery && (b = b || (typeof jQuery !== "undefined" ? jQuery : null)) && !(p.jQuery && b.fn.jquery !== p.jQuery) && ("holdReady" in b || "readyWait" in b))
                if (g.jQuery = b, n(["jquery", [],
                    function() {
                        return jQuery
                    }
                ]), g.scriptCount) U(b, !0), g.jQueryIncremented = !0
        };
        w = function() {
            var b, a, c, h, j, i;
            Y += 1;
            ...
            for (; P.length;)
                if (b = P.shift(), b[0] === null) return d.onError(N("mismatch", "Mismatched anonymous define() module: " + b[b.length - 1]));
                else n(b);
            if (!p.priorityWait || k())
                for (; g.paused.length;) {
                    j = g.paused;
                    ...
                    g.paused = [];
                    for (h = 0; b = j[h]; h++) a = b.map, c = a.url, i = a.fullName, a.prefix ? u(a.prefix, b) : !S[c] && !s[i] && (d.load(g, i, c), c.indexOf("empty:") !== 0 && (S[c] = !0));
        ...
        g = {
            ...
            require: function(b, c, f) {
                ...
                }(b && b.length || c) && A(null, b, c, f);
                if (!g.requireWait)
                    for (; !g.scriptCount && g.paused.length;) g.takeGlobalQueue(), w();
                return g.require
            },
            takeGlobalQueue: function() {
                T.length && (ha.apply(g.defQueue, [g.defQueue.length - 1, 0].concat(T)), T = [])
            },
    ...
    function ia() {
        ...
        for (c = a.length - 1; c > -1 && (d = a[c]); c--)
            if (d.readyState === "interactive") return n = d;
        return null
    }
    var ja =
        /(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/mg,
        ...
        X = 0,
        O = !1,
        d, r = {}, I, v, t, x, u, y, z, H, A, V, W;
    if (typeof define === "undefined") {
        if (typeof requirejs !==
            "undefined")
            if (J(requirejs)) return;
            else r = requirejs, requirejs = void 0;
        ...
        if (d.isAsync =
            d.isBrowser = G)
            if (t = v.head = document.getElementsByTagName("head")[0], x = document.getElementsByTagName("base")[0]) t = v.head = x.parentNode;
        ...
        define = function(a, c, d) {
            ...
            if (O && (k = I || ia())) a || (a = k.getAttribute("data-requiremodule")), j = D[k.getAttribute("data-requirecontext")];
            (j ? j.defQueue : T).push([a, c, d])
        };
        define.amd = {
            multiversion: !0,
            plugins: !0,
        ...
        d.addScriptToDom = function(a) {
            I = a;
            x ? t.insertBefore(a, x) : t.appendChild(a);
            I = null
        };
        ...
        if (G) {
            ...
            for (H = u.length - 1; H > -1 && (y = u[H]); H--) {
                if (!t) t = y.parentNode;
                if (z = y.getAttribute("data-main")) {
                    if (!r.baseUrl) u =
                        z.split("/"), y = u.pop(), u = u.length ? u.join("/") + "/" : "./", r.baseUrl = u, z = y.replace(aa, "");
                    r.deps = r.deps ? r.deps.concat(z) : [z];
                    break
                }
            }
        }
        d.checkReadyState = function() {
            var a = v.contexts,
                c;
            for (c in a)
                if (!(c in K) && a[c].waitCount) return;
            d.resourcesReady(!0)
        };
        d.resourcesReady = function(a) {
            ...
            if (d.resourcesDone)
                for (h in a = v.contexts, a)
                    if (!(h in K) && (c = a[h], c.jQueryIncremented)) U(c.jQuery, !1), c.jQueryIncremented = !1
        };
        ...
        d(r);
        if (d.isAsync && typeof setTimeout !== "undefined") A = v.contexts[r.context || "_"], A.requireWait = !0, setTimeout(function() {
            A.requireWait = !1;
            A.takeGlobalQueue();
            A.scriptCount || A.resume();
            d.checkReadyState()
        }, 0)
    }
})();
;define(['tollstations'], [{
    name: 'Αγ. Παρασκευής Βόρεια',
    lat: 38.009020,
    lng: 23.842207
}, {
    name: 'Αγ. Παρασκευής Νότια',
    lat: 38.008030,
    lng: 23.836570
}, {
    name: 'Αιγάλεω Ανατολικά',
    lat: 38.075699,
    lng: 23.676229
}, {
    name: 'Αιγάλεω Δυτικά',
    ...
    name: 'Ασπρόπυργος Ανατολικά',
    lat: 38.089138,
    lng: 23.622208
}, {
    name: 'Ασπρόπυργος Δυτικά',
    lat: 38.090488,
    lng: 23.618928
}, {
    name: 'Γέρακας Ανατολικά',
    lat: 38.018949,
    lng: 23.861633
}, {
    name: 'Γλυκά Νερά Βόρεια',
    lat: 37.997234,
    lng: 23.851355
}, {
    name: 'Γλυκά Νερά Νότια',
    lat: 37.997475,
    lng: 23.849339
}, {
    name: 'Δημοκρατίας Ανατολικά',
    lat: 38.065994,
    lng: 23.734411
}, {
    name: 'Δημοκρατίας Δυτικά',
    lat: 38.067420,
    lng: 23.731419
}, {
    name: 'Δημόκριτος Βόρεια',
    lat: 37.999554,
    lng: 23.821350
}, {
    name: 'Δουκ. Πλακεντίας Ανατολική',
    lat: 38.023962,
    lng: 23.834758
}, {
    name: 'Δουκ. Πλακεντίας Δυτική',
    lat: 38.025213,
    lng: 23.833832
}, {
    name: 'Δουκ. Πλακεντίας Νότια',
    lat: 38.019261,
    lng: 23.837696
}, {
    name: 'Ηράκλειο Ανατολική',
    lat: 38.056340,
    lng: 23.772335
}, {
    name: 'Ηράκλειο Δυτικά',
    lat: 38.058622,
    lng: 23.768783
}, {
    name: 'Κάντζα Ανατολική',
    lat: 37.979888,
    lng: 23.869927
}, {
    name: 'Κάντζα Δυτική',
    ...
    name: 'Κατεχάκη Βόρεια',
    lat: 37.977140,
    lng: 23.799987
}, {
    name: 'Κηφισίας Ανατολική',
    lat: 38.041167,
    lng: 23.805374
}, {
    name: 'Κηφισίας Δυτική',
    lat: 38.043717,
    lng: 23.799236
}, {
    name: 'Κορωπι Δυτικά',
    ...
    name: 'Μαραθώνος Ανατολική',
    lat: 38.004187,
    lng: 23.869668
}, {
    name: 'Μαραθώνος Δυτική',
    lat: 38.007557,
    lng: 23.869332
}, {
    name: 'Μεταμόρφωση Ανατολική',
    lat: 38.061081,
    lng: 23.750468
}, {
    name: 'Μεταμόρφωση Δυτική',
    lat: 38.063006,
    lng: 23.748535
}, {
    name: 'Παιανία Ανατολική',
    lat: 37.953307,
    lng: 23.885705
}, {
    name: 'Παιανία Δυτική',
    ...
    name: 'Πεντέλης Ανατολική',
    lat: 38.027064,
    lng: 23.829293
}, {
    name: 'Πεντέλης Δυτική',
    lat: 38.034361,
    lng: 23.821561
}, {
    name: 'Ρουπάκι Ανατολικά',
    lat: 38.094009,
    lng: 23.591060
}, {
    name: 'Φυλής Ανατολικά',
    lat: 38.070104,
    lng: 23.711515
}, {
    name: 'Φυλής Δυτικά',
